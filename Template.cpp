...
HeapMem::HeapMem(const HeapMem& rhs) {// Copy constructor! Let *this = rhs
...
HeapMem& HeapMem::operator=(const HeapMem& rhs) {// Assignment operator! First delete original data, then copy the rhs.data to this
...
HeapMem::~HeapMem() {// Destructor! Delete data, that's it!
	delete data;
